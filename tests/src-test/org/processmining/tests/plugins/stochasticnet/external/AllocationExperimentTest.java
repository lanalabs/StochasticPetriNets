...
//			runComplexityExperiment(stochNet, "ROADComplexityExperimentResults."+suffix+".csv", maxCapacity, dropOffRate, noise);
//			
//			// noise Experiment
//			runNoiseExperiment(stochNet, "ROADNoiseExperimentResults."+suffix+".csv", dropOffRate, meanTimeBetweenArrivals);
//			
//			// ambiguity Experiment
//			runAmbiguityExperiment(stochNet, "ROADAmbiguityExperimentResults."+suffix+".csv", meanTimeBetweenArrivals, maxResources);
//		}
//	}
//
//	protected void runAmbiguityExperiment(StochasticNet stochNet, String fileName,
//			double meanTimeBetweenArrivals, int maxResources) {
...
//						numCases, noise, ExperimentType.AMBIGUITY));
//			}
//		}
...
//				resultFileLines.addAll(runExperiment(i, stochNet, rooms, maxCapacity, nResources, dropOffRate, meanTimeBetweenArrivals,
//						numCases, noiseLevel, ExperimentType.NOISE));
//			}
//		}
//		finalString = Joiner.on("\n").join(resultFileLines);
//		StochasticNetUtils.writeStringToFile(finalString, fileName);
...
//			int maxCapacity, double dropOffRate, double noise) {
...
//						numCases, noise, ExperimentType.COMPLEXITY));
//			}
//		}
...
//			double noise, ExperimentType experimentType) {
...
//				allResources, numCases, meanTimeBetweenArrivals, noise);
//
...
//	}
//
//	private PetrinetModelAllocations generateAllocations(Petrinet net, int nResources, double dropOffRate,
