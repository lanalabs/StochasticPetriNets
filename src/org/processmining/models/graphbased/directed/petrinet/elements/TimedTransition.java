...
//				distribution = new Beta(distributionParameters[0], distributionParameters[1]);
				break;
			case NORMAL:
...
//				distribution = new Gaussian(distributionParameters[0], distributionParameters[1]);
				break;
			case LOGNORMAL:
...
//				distribution = new Lognormal(distributionParameters[0], distributionParameters[1]);
				break;
			case EXPONENTIAL:
				checkParameterLengthForDistribution(1, "lamda");
				distribution = new ExponentialDistribution(distributionParameters[0]);
//				distribution = new Exponential(distributionParameters[0]);
				break;
			case GAMMA:
...
//				distribution = new Uniform(distributionParameters[0], distributionParameters[1]);
				break;
	...
	public void setDistributionParameters(List<Double> transitionStats) {
		distributionParameters = new double[transitionStats.size()];
		Iterator<Double> iter = transitionStats.iterator();
		int i = 0;
		while(iter.hasNext()){
			distributionParameters[i++] = iter.next();
		}
	}
